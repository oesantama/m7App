    ...
    <div className="space-y-4 animate-in fade-in duration-700 pb-4 h-full flex flex-col overflow-hidden max-h-screen">
      ...
      <div className="bg-white p-5 rounded-[2.5rem] shadow-lg border border-slate-100 flex justify-between items-center shrink-0 transition-all">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-slate-900 rounded-2xl flex items-center justify-center text-emerald-500 shadow-md"><Icons.Scan /></div>
          <div>
            <h2 className="text-xl font-black text-slate-900 uppercase tracking-tighter leading-none">M7 Recibo Físico</h2>
            <p className="text-[9px] text-slate-400 font-black uppercase tracking-widest mt-1.5">Auditoría & Sincronización Tiempo Real</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 min-h-0">
        {selectedDocForCount ? (
          ...
          <div className="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 overflow-hidden h-full flex flex-col">
            ...
            <div className="p-8 flex-1 overflow-y-auto custom-scrollbar bg-slate-50/5">
