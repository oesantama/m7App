...
const CITY_TO_DEPT: Record<string, string> = {
  ...
  'GUARNE': 'ANTIOQUIA', 'CARMEN DE VIBORAL': 'ANTIOQUIA', 'CAUCASIA': 'ANTIOQUIA', 'CAÑASGORDAS': 'ANTIOQUIA',
  'GOMEZ PLATA': 'ANTIOQUIA', 'JARDIN': 'ANTIOQUIA', 'ARBOLETES': 'ANTIOQUIA', 'SAN JUAN DE URABA': 'ANTIOQUIA',
  'SAN PEDRO': 'ANTIOQUIA', 'AMAGA': 'ANTIOQUIA', 'LA CEJA': 'ANTIOQUIA', 'SAN LUIS': 'ANTIOQUIA',
  'SONSON': 'ANTIOQUIA', 'SANTA ROSA DE OSOS': 'ANTIOQUIA', 'APARTADO': 'ANTIOQUIA',
  
  // VALLE DEL CAUCA
  'CALI': 'VALLE DEL CAUCA', 'YUMBO': 'VALLE DEL CAUCA', 'PALMIRA': 'VALLE DEL CAUCA', 'BUENAVENTURA': 'VALLE DEL CAUCA',
  'CARTAGO': 'VALLE DEL CAUCA', 'GINEBRA': 'VALLE DEL CAUCA', 'LA CUMBRE': 'VALLE DEL CAUCA', 'JAMUNDI': 'VALLE DEL CAUCA',
  
  // CORDOBA
  'MONTERIA': 'CORDOBA', 'VALENCIA': 'CORDOBA', 'CERETE': 'CORDOBA', 'CHINU': 'CORDOBA', 'LORICA': 'CORDOBA',
  'PUEBLO NUEVO': 'CORDOBA', 'PUERTO LIBERTADOR': 'CORDOBA', 'SAN BERNARDO DEL VIENTO': 'CORDOBA', 'TIERRALTA': 'CORDOBA',
  
  // CUNDINAMARCA / BOGOTA
  'BOGOTA': 'CUNDINAMARCA', 'BOGOTA D.C.': 'CUNDINAMARCA', 'BOGOTA, DISTRITO CAPITAL': 'CUNDINAMARCA',
  'COTA': 'CUNDINAMARCA', 'FUNZA': 'CUNDINAMARCA', 'MOSQUERA': 'CUNDINAMARCA',
  
  // ATLANTICO
  'BARRANQUILLA': 'ATLANTICO', 'SOLEDAD': 'ATLANTICO',
