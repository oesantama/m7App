...
Asistente virtual M7 con inteligencia artificial para soporte operativo en tiempo real.
...
2. En el menú lateral izquierdo, localice y haga clic en **Help Chat**.
3. Espere a que el módulo cargue completamente (indicador de carga en la parte superior).

### 2. Creación y edición de registros
