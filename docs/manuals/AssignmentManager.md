# Manual de Usuario — AssignmentManager

> **Sistema:** OrbitM7 — Milla 7 Logística
> **Módulo:** `AssignmentManager`
...
Asignación de conductores y vehículos a rutas de entrega, con control de disponibilidad y conflictos.
...
2. En el menú lateral izquierdo, localice y haga clic en **Assignment Manager**.
...
| `clients` | `MasterRecord[]` | Propiedad `clients` |
| `onAssign` | `(vId` | Propiedad `onAssign` |
| `onEndAssignment` | `(aId` | Propiedad `onEndAssignment` |
