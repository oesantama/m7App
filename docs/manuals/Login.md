...
Pantalla de autenticación con soporte para 2FA, recuperación de contraseña y control de sesión.
...
2. En el menú lateral izquierdo, localice y haga clic en **Login**.
...
### 3. Creación y edición de registros
...
|----------|-------------|
| `/api/auth/forgot-password` | Operación de API |
| `/api/2fa/verify` | Operación de API |
### Propiedades del componente

| Propiedad | Tipo | Descripción |
|-----------|------|-------------|
| `onLogin` | `(email` | Propiedad `onLogin` |
