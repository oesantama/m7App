# Manual de Usuario — ExecutiveDashboard

> **Sistema:** OrbitM7 — Milla 7 Logística
> **Módulo:** `ExecutiveDashboard`
...
Panel ejecutivo con KPIs, gráficos de rendimiento y resumen operativo en tiempo real.
...
2. En el menú lateral izquierdo, localice y haga clic en **Executive Dashboard**.
