...
export type PageModule = 'home' | 'master' | 'inventory' | 'inventory-counts' | 'routes' | 'users' | 'drivers' | 'assignments' | 'reports' | 'notifications' | 'scanning' | 'whatsapp' | 'whatsapp-campaign' | 'whatsapp-status' | 'alertas-whatsapp' | 'balance' | 'training' | 'inventory-news' | 'dispatch' | 'picking' | 'recibido-manual' | 'grupo-inter-ops' | 'conciliacion' | 'gestion-humana-miscelaneos' | 'cfg-ciudades' | 'prov-clientes' | 'validacion-conciliaciones' | 'fletes-conciliacion' | 'informe-dashboard-drive' | 'auditoria-factura' | 'informes-gerenciales';
