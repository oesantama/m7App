...
export type PageModule = 'home' | 'master' | 'inventory' | 'inventory-counts' | 'routes' | 'users' | 'drivers' | 'assignments' | 'reports' | 'notifications' | 'scanning' | 'whatsapp' | 'whatsapp-campaign' | 'whatsapp-status' | 'balance' | 'training' | 'inventory-news' | 'dispatch' | 'picking' | 'recibido-manual' | 'grupo-inter-ops' | 'conciliacion' | 'gestion-humana-miscelaneos' | 'cfg-ciudades' | 'validacion-conciliaciones' | 'fletes-conciliacion' | 'informe-dashboard-drive';
