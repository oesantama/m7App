...
export const ID_MAP: Record<string, string> = {
  ...
  'LEGALIZACIONES_DICORP': 'PAG-58',
  'BASC_DASHBOARD': 'PAG-70',
  'BASC_DRIVE_SYNC': 'PAG-71',
  'BASC_AUDITOR_AI': 'PAG-72',
  'BASC_REPORTES': 'PAG-73',
  'CIBERSEGURIDAD': 'PAG-69',
  'ALERTAS_WHATSAPP': 'PAG-02',
  'GESTOR_DB': 'PAG-59',
  'INVENTARIOS_ACTIVOS': 'PAG-74',
  'GRUPO_INTER_OPS': 'PAG-31'
};
