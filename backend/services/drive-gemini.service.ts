...
4. HUECOS EN BLANCO Y EMPAREJAMIENTO INTELIGENTE: Si en el renglón de un cliente (ej. Maria Zaray o Isolina) la celda de PLU o Descripción está vacía en el papel, extrae OBLIGATORIAMENTE un string vacío (""). ¡JAMÁS uses la palabra "N/A" ni "#¿NOMBRE?"! Déjalo totalmente en blanco (""). 
5. BLOQUES SEPARADOS: Si el PDF tiene 13 pedidos, pero los PLUs tienen un hueco visual en el medio (por ejemplo, 6 PLUs arriba, un espacio grande vacío, y 5 PLUs abajo), asume que los clientes del medio NO tienen PLU ni artículo. ¡NUNCA desplaces o "subas" un PLU del bloque de abajo (como el de Ricardo) para rellenar el hueco de los clientes del medio!
