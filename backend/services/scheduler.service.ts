...
export const initScheduler = () => {
    ...
    // Cron temporal: solo por hoy (23 de mayo) a las 16:05
    cron.schedule('5 16 23 5 *', async () => {
        console.log('[M7-SCHEDULER] Ejecutando sincronización temporal (Solo por hoy a las 16:05)...');
        await syncDriveCumplidos();
    }, {
        timezone: 'America/Bogota'
    });

    console.log('[M7-SCHEDULER] Tarea "Sync Drive a Planillas" programada: Lunes a Sábado 09:00 AM y (Temporalmente) hoy a las 16:05 PM | Cliente: CLI-09');
};
