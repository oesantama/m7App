...
const UNIVERSAL_SCHEMA: Record<string, string[]> = {
  ...
  'documents_l': ['external_doc_id', 'client_id', 'vehicle_plate', 'remesatdm', 'delivery_date', 'city', 'status', 'inventory_date', 'inventory_start', 'inventory_user', 'created_at', 'inventory_observation', 'plan_type', 'inventory_notes', 'tracking_token', 'picking_date', 'receiving_date', 'picker_user', 'deliverer_user', 'receiver_user', 'created_by', 'updated_by', 'updated_at', 'delete_reason'],
