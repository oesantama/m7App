  ...
  try {
    ...
    await client.query(`
      DELETE FROM pages WHERE id NOT IN (
        ...
        'PAG-25','PAG-26','PAG-27','PAG-28','PAG-29','PAG-30','PAG-SQL'
      )
    `);
    await client.query(`
