...
2. PROCESAMIENTO EN TIEMPO REAL: Los usuarios pueden subir archivos Excel o JSON para validar datos sin necesidad de almacenamiento persistente.
3. NOTIFICACIONES: Sistema de alertas por Email y WhatsApp automatizado.
4. ANÁLISIS POR IA: Capacidad de analizar documentos y fotos logísticas usando Gemini Vision.
