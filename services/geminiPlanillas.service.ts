...
class GeminiPlanillasService {
  ...
  async analyzeDocument(fileBuffer: ArrayBuffer, mimeType: string): Promise<any[]> {
    ...
    const prompt = `
      ...
      9. Los números de "Pedido" en el Éxito suelen empezar por 16 o 26. Lee dígito por dígito con extrema precisión.
      10. LIMPIEZA OBLIGATORIA DEL PEDIDO: Si ves letras o guiones antes del pedido (ej. "E-com 163287..."), IGNÓRALOS. Extrae ÚNICAMENTE LOS NÚMEROS.
